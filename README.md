...
## 2. Identification of Methylation Quantitative Trait Loci
...
## 3. Rudimentary Photoshop: written in ANSI C without use of APIs or such.  
...
## 4. Chess: written in C++ without the use of APIs or such.  
...
## 5. Quorum Sensing Simulator: Python simulation modeled on Hill Equation.  
From Wikipedia:  
